#### Maven简介说明
- Apache Maven是一个项目管理和理解工具,可理解成管理第三方库的依赖及构建
- 官网[https://maven.apache.org/index.html]

##### PMO(Project Object Model)
- Maven所有项目的配置放在PMO(常见的pmo.xml)文件中

##### PMO坐标
- groupId,artifactId,version,packaging 叫做PMO坐标，他们组合确定项目唯一
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
   ...
   <groupId>com.abecedarian.demo</groupId> <!-- 公司或者组织的唯一标志 -->
   <artifactId>demo-tutorial</artifactId>  <!-- 本项目的唯一ID，一个groupId下面可能多个项目，就是靠artifactId来区分的 -->
   <version>1.0.0</version>   <!-- 本项目目前所处的版本号 -->
   <packaging>war</packaging>  <!-- 打包的机制，如pom,jar, maven-plugin, ejb, war, ear, rar, par，默认为jar -->
